...
class SeriesRecyclerViewOnScrollListener(private val characterPresenter: CharacterPresenter, private val characterId: Long, private val offset: Int, private val count: Int, private val total: Int) :
    ...
    override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        if (!isLastPage && isAtEndOfRecyclerView) {
            if (!searching) {
                searching = true
                characterPresenter.searchSeries(characterId, offset + count)
            }
